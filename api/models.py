...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, company_name, office_name, postal_code, address, representative_name, phone_number, email, password=None):
...
class UserService(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name="病院名・もしくは法人名", on_delete=models.CASCADE, related_name="user", blank=True)
    created_at = models.DateTimeField(verbose_name="登録日時", auto_now_add=True)
    updated_at = models.DateTimeField(verbose_name="更新日時", auto_now_add=True)
